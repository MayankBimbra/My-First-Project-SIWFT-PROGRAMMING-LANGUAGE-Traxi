...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    var window: UIWindow?
    //MARK:- Shared Instance of SceneDelegate
    ...
    func scene(_ scene: UIScene, willConnectTo session: UISceneSession, options connectionOptions: UIScene.ConnectionOptions) {
        ...
        if coreData.shared.accessToken != ""{
            ...
            let initialViewController : UIViewController = mainStoryboard.instantiateViewController(withIdentifier: "tabbarVC") as! tabbarVC
        ...
        SceneDelegate.shared.window = self.window
    }
